...
String _$searchHash() => r'4469a4b9bfe248a46b0bd71e36a3421dd4dfaf78';
...
/// See also [search].
class SearchFamily extends Family<AsyncValue<List<NationApiModel>>> {
  /// See also [search].
  const SearchFamily();
...
/// See also [search].
class SearchProvider extends AutoDisposeFutureProvider<List<NationApiModel>> {
  /// See also [search].
  SearchProvider(
    String? query,
  ) : this._internal(
  ...
  Override overrideWith(
    FutureOr<List<NationApiModel>> Function(SearchRef provider) create,
  ) {
  ...
  @override
  AutoDisposeFutureProviderElement<List<NationApiModel>> createElement() {
...
mixin SearchRef on AutoDisposeFutureProviderRef<List<NationApiModel>> {
  /// The parameter `query` of this provider.
  String? get query;
}

class _SearchProviderElement
    extends AutoDisposeFutureProviderElement<List<NationApiModel>>
    with SearchRef {
